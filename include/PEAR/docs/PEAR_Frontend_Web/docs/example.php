...
if ($env=getenv('PHP_PEAR_INSTALL_DIR')) {
    ...
    putenv('PHP_PEAR_INSTALL_DIR=c:/progra~1/easyphp1-7/php/pear/PEAR');
}
/*
...
if ($env=getenv('PHP_PEAR_BIN_DIR')) {
    ...
    putenv('PHP_PEAR_BIN_DIR=c:/progra~1/easyphp1-7/php/pear');
}
/*
...
if ($env=getenv('PHP_PEAR_PHP_BIN')) {
    ...
    putenv('PHP_PEAR_PHP_BIN=c:/progra~1/easyphp1-7/php/');
}
...
ini_set('include_path', 'c:/progra~1/easyphp1-7/php/pear/PEAR');
// Configfile
